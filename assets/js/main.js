  ...
  const FALLBACK = {
    ...
    projects: [
      ...
      },
      {
        ...
        tags: ['TypeScript', 'Next.js', 'Yahoo Finance'],
        category: 'web',
      ...
      },
      {
        id: 14,
        title: 'Tracer',
        desc: 'End-to-end cattle tracking system covering farm management, livestock transport logistics, and marketplace trading. Three-tier architecture: Vite web app, React Native mobile app, and a high-performance Go REST API.',
        tags: ['Vite', 'React Native', 'Go'],
        category: 'fullstack',
        icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="3"/><path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7z"/><path d="M8.5 9a3.5 3.5 0 017 0"/></svg>',
        private: false,
        demo: 'https://new.tracer.in.th/',
        repo: null,
      },
      {
        id: 15,
        title: 'Rama Hospital Voice Interview',
        desc: 'A voice-driven patient questionnaire web application for Ramathibodi Hospital. Conducts structured interviews using Text-to-Speech (TTS) to read questions aloud, records patient responses via Speech-to-Text (STT), and processes the transcribed answers for clinical data analysis.',
        tags: ['Yii2', 'TTS', 'STT'],
        category: 'web',
        icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2a3 3 0 00-3 3v7a3 3 0 006 0V5a3 3 0 00-3-3z"/><path d="M19 10v2a7 7 0 01-14 0v-2"/><line x1="12" y1="19" x2="12" y2="23"/><line x1="8" y1="23" x2="16" y2="23"/></svg>',
        private: true,
        demo: null,
        repo: null,
      },
      {
        id: 16,
        title: 'WU Thasala',
        desc: 'A mobile application for Walailak University staff. Provides convenient access to internal university services and information for personnel on the go.',
        tags: ['React Native'],
        category: 'mobile',
        ...
        private: false,
        demo: 'https://wuthasala.vercel.app/',
        repo: null,
      },
    ],
    experience: [
